...
There are $T$ queries:
\begin{itemize}
  \item \texttt{1 p q x y}: Invert all bits from rectangle with row from $p$ to $q$ and columns from $x$ to $y$ (inclusive) of table $A$. Here, $1 \le p \le q \le 2$, and $1 \le x \le y \le n$.
